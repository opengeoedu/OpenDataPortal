...
con <- DBI::dbConnect(odbc::odbc(), 
                 ...
                 timeout = 10)
DBI::dbWriteTable(con,DBI::Id(schema="api",table="portale"),portale, overwrite=TRUE)
...
portale <- infer_location_information(portale)
...
#portale.gk3 <- spTransform(portale.sp, CRS("+init=epsg:25832")) #GK Zone 3 --> ERTS UTM 32N
portale.gk3 <- spTransform(portale.sp, CRS("+init=epsg:3035")) #GK Zone 3 --> ERTS LAEA
...
proj4string(portale.gk3.shifted) <- CRS("+init=epsg:3035")
